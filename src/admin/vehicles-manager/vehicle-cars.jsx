                                    ...
                                    Object.values(cars).map((item, index) => {
                                        ...
                                        return (
                                            <Accordion.Item key={index} eventKey={index}>
                                                <Accordion.Header
                                                    className="m-0 p-0">{currBrandName} / {currModelName}</Accordion.Header>
                                                <Accordion.Body>
                                                    ...
                                                    <div className="mt-3 input-groups-2">
                                                        ...
                                                        <InputGroup className="my-1">
                                                            ...
                                                            <Select
                                                                ...
                                                                defaultValue={item.availableLocations && item.availableLocations.map(i => ({
                                                                    label: locations[i],
                                                                    value: i
                                                                }))}
                                                                options={Object.entries(locations).map(([key, value]) => ({
                                                                    label: value,
                                                                    value: key
                                                                }))}
                                                    ...
                                                    <div className="mt-3 input-groups-2">
                                                        <Button variant="success" type="button"  className="w-100" onClick={handleSaveChangesButton}>
                                                            Save Changes
                                                        </Button>
                                        ...
                                        <Form onSubmit={handleAddNewSubmit}>
                                            <div className="mb-3 input-groups-1">
                                                ...
                                                <InputGroup className="my-1">
                                                    ...
                                                    <Form.Control type="text" name="engineSize"
                                                                  placeholder="Engine Size" required={true}/>
                                                </InputGroup>
                                                <InputGroup className="my-1">
                                                    <InputGroup.Text>Gearbox</InputGroup.Text>
                                            ...
                                            <div className="mt-3 input-groups-2">
                                                <h3 className="text-white">Vehicle Info</h3>
                                                <InputGroup className="my-1">
                                                    <InputGroup.Text>Car Count</InputGroup.Text>
                                                    <Form.Control type="number" name="carCount"
                                                                  placeholder="Available Car Count..." required={true}/>
                                                </InputGroup>
                                                <InputGroup className="my-1">
                                                    <InputGroup.Text>Available Locations</InputGroup.Text>
                                                    <Select

        ...
        resultsRender.push(
            <Carousel.Item key={`review_carousel_${i}`} interval={99999}>
                <Carousel.Caption className="carousel-caption text-dark text-start">
                    <Row>
                        {reviewsData.slice(i, i + 2).map((review, index) => (
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        ...
                                        <div className="review-star text-center">
                                            {Array.from({ length: review.customerStar }).map((val, inx) => (
                                                <AiFillStar key={`star_${inx}`} />
                                            ))}
                                        </div>
                                    </Card.Body>
                                </Card>
                        ...
                        <Row>
                            <Col xs={2} className="position-relative">
                                <div className="position-absolute top-50">
                                    <Button variant="outline-dark" onClick={onPrevClick} className="primary-bg-color border-0 rounded-0" size="lg">
                                        <GrPrevious color="white" />
                                    </Button>
                                </div>
                            </Col>
                            <Col xs={8} className="p-0">
                                <Carousel ref={sliderRef}>{resultsRender}</Carousel>
                            </Col>
                            <Col xs={2} className="position-relative">
                                <div className="position-absolute top-50">
                                    <Button variant="outline-dark" onClick={onNextClick} className="primary-bg-color border-0 rounded-0" size="lg">
                                        <GrNext color="white" />
                                    </Button>
                                </div>
                            </Col>
